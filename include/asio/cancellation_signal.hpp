...
class cancellation_handler : public cancellation_handler_base
{
  public:
    template <typename... Args>
    cancellation_handler(std::size_t size, Args &&...args) : handler_(static_cast<Args &&>(args)...), size_(size)
    {
    }
...
{
  public:
    constexpr cancellation_signal() : handler_(0)
    {
    }
...
class cancellation_slot
{
  public:
    ...
    constexpr cancellation_slot() : handler_(0)
    {
    }
  ...
  private:
    ...
    constexpr cancellation_slot(int, detail::cancellation_handler_base **handler) : handler_(handler)
    {
    }
