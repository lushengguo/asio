...
class basic_descriptor : public descriptor_base
{
  ...
  public:
     ...
     * descriptor.
     */
    explicit basic_descriptor(const executor_type &ex) : impl_(0, ex)
    {
    }
     ...
     */
    basic_descriptor(const executor_type &ex, const native_handle_type &native_descriptor) : impl_(0, ex)
    {
        asio::error_code ec;
     ...
     */
    template <typename ExecutionContext>
    basic_descriptor(ExecutionContext &context, const native_handle_type &native_descriptor,
     ...
     * constructor.
     */
    basic_descriptor(basic_descriptor &&other) noexcept : impl_(std::move(other.impl_))
    {
    }
