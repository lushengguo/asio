...
struct prefer_only_property
{
    ...
    prefer_only_property(const InnerProperty &p) : property(p)
    {
    }
};
...
template <typename T>
struct prefer_only_memfns_derived : T, prefer_only_memfns_base
{
};
                                        ...
                                        !is_same<typename InnerProperty::polymorphic_query_result_type, void>::value>>
{
    ...
    constexpr typename InnerProperty::polymorphic_query_result_type value() const
    {
        return property.value();
    }
};
                     ...
                     detail::prefer_only_property<InnerProperty>
{
    ...
    constexpr prefer_only(const InnerProperty &p) : detail::prefer_only_property<InnerProperty>(p)
    {
    }
    ...
    friend constexpr prefer_result_t<const Executor &, const InnerProperty &> prefer(
        const Executor &ex, const prefer_only<Property> &p, enable_if_t<is_same<Property, InnerProperty>::value> * = 0,
    ...
    template <typename Executor, typename Property>
    friend constexpr query_result_t<const Executor &, const InnerProperty &> query(
        const Executor &ex, const prefer_only<Property> &p, enable_if_t<is_same<Property, InnerProperty>::value> * = 0,
