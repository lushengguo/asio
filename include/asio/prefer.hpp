...
struct can_prefer : integral_constant<bool, automatically_determined>
{
};
...
template <typename Impl, typename T, typename Properties, typename = void, typename = void, typename = void,
...
struct call_traits<Impl, T, void(Property), enable_if_t<is_applicable_property<decay_t<T>, decay_t<Property>>::value>,
                   enable_if_t<decay_t<Property>::is_preferable>, enable_if_t<static_require<T, Property>::is_valid>>
{
...
struct call_traits<Impl, T, void(P0, P1), enable_if_t<call_traits<Impl, T, void(P0)>::overload != ill_formed>,
                   enable_if_t<call_traits<Impl, typename call_traits<Impl, T, void(P0)>::result_type,
...
struct call_traits<Impl, T, void(P0, P1, PN...), enable_if_t<call_traits<Impl, T, void(P0)>::overload != ill_formed>,
                   enable_if_t<call_traits<Impl, typename call_traits<Impl, T, void(P0)>::result_type,
...
template <typename T, typename... Properties>
struct can_prefer : integral_constant<bool, asio_prefer_fn::call_traits<prefer_t, T, void(Properties...)>::overload !=
