...
class posix_serial_port_service : public execution_context_service_base<posix_serial_port_service>
{
  public:
    ...
    void move_assign(implementation_type &impl, posix_serial_port_service &other_service,
  ...
  private:
    ...
    ASIO_DECL asio::error_code do_set_option(implementation_type &impl, store_function_type store, const void *option,
                                             asio::error_code &ec);
    ...
    ASIO_DECL asio::error_code do_get_option(const implementation_type &impl, load_function_type load, void *option,
                                             asio::error_code &ec) const;
