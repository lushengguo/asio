...
class work_dispatcher
{
  public:
    ...
    work_dispatcher(const work_dispatcher &other) : handler_(other.handler_), executor_(other.executor_)
    {
    }
...
class work_dispatcher<Handler, Executor, enable_if_t<!execution::is_executor<Executor>::value>>
{
  public:
    template <typename CompletionHandler>
    work_dispatcher(CompletionHandler &&handler, const Executor &handler_ex)
        : work_(handler_ex), handler_(static_cast<CompletionHandler &&>(handler))
    {
    }
