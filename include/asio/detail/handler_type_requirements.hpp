...
auto two_arg_move_handler_test(Handler h, Arg1 *a1, Arg2 *a2)
    -> decltype(sizeof(Handler(static_cast<Handler &&>(h))),
                (static_cast<Handler &&>(h)(*a1, static_cast<Arg2 &&>(*a2))), char(0));
...
#define ASIO_READ_HANDLER_CHECK(handler_type, handler)                                                                 \
    ...
    typedef asio::detail::handler_type_requirements<                                                                   \
        ...
        sizeof(asio::detail::rorlvref<asio_true_handler_type>()(asio::detail::lvref<const asio::error_code>(),         \
