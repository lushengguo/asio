...
class any_completion_handler_impl : public any_completion_handler_impl_base
{
  public:
    template <typename S, typename H>
    any_completion_handler_impl(S &&slot, H &&h)
        : any_completion_handler_impl_base(static_cast<S &&>(slot)), handler_(static_cast<H &&>(h))
    {
    }

    struct uninit_deleter
    {
        typename std::allocator_traits<associated_allocator_t<Handler, asio::recycling_allocator<void>>>::
            template rebind_alloc<any_completion_handler_impl>
                alloc;
...
class any_completion_handler_call_fn<R(Args...)>
{
  public:
    ...
    constexpr any_completion_handler_call_fn(type fn) : call_fn_(fn)
    {
    }
...
class any_completion_handler_call_fns<Signature, Signatures...> : public any_completion_handler_call_fn<Signature>,
                                                                  public any_completion_handler_call_fns<Signatures...>
{
  public:
    ...
    constexpr any_completion_handler_call_fns(CallFn fn, CallFns... fns)
        : any_completion_handler_call_fn<Signature>(fn), any_completion_handler_call_fns<Signatures...>(fns...)
    {
    }
...
class any_completion_handler_destroy_fn
{
  public:
    ...
    constexpr any_completion_handler_destroy_fn(type fn) : destroy_fn_(fn)
    {
    }
...
class any_completion_handler_executor_fn
{
  public:
    ...
    constexpr any_completion_handler_executor_fn(type fn) : executor_fn_(fn)
    {
    }
...
class any_completion_handler_immediate_executor_fn
{
  public:
    ...
    constexpr any_completion_handler_immediate_executor_fn(type fn) : immediate_executor_fn_(fn)
    {
    }
...
class any_completion_handler_allocate_fn
{
  public:
    ...
    constexpr any_completion_handler_allocate_fn(type fn) : allocate_fn_(fn)
    {
    }
...
class any_completion_handler_deallocate_fn
{
  public:
    ...
    constexpr any_completion_handler_deallocate_fn(type fn) : deallocate_fn_(fn)
    {
    }
                                        ...
                                        private any_completion_handler_call_fns<Signatures...>
{
  public:
    ...
    constexpr any_completion_handler_fn_table(any_completion_handler_destroy_fn::type destroy_fn,
                                              ...
                                              CallFns... call_fns)
        : any_completion_handler_destroy_fn(destroy_fn), any_completion_handler_executor_fn(executor_fn),
          any_completion_handler_immediate_executor_fn(immediate_executor_fn),
          any_completion_handler_allocate_fn(allocate_fn),
          any_completion_handler_deallocate_fn(deallocate_fn), any_completion_handler_call_fns<Signatures...>(
                                                                   call_fns...)
    {
    }
...
struct any_completion_handler_fn_table_instance
{
    static constexpr any_completion_handler_fn_table<Signatures...> value =
        any_completion_handler_fn_table<Signatures...>(
            &any_completion_handler_destroy_fn::impl<Handler>, &any_completion_handler_executor_fn::impl<Handler>,
            &any_completion_handler_immediate_executor_fn::impl<Handler>,
            &any_completion_handler_allocate_fn::impl<Handler>, &any_completion_handler_deallocate_fn::impl<Handler>,
...
class any_completion_handler_allocator
{
  private:
    ...
    constexpr any_completion_handler_allocator(int, const any_completion_handler<Signatures...> &h) noexcept
        : fn_table_(h.fn_table_), impl_(h.impl_)
    {
    }
...
class any_completion_handler
{
  ...
  public:
    ...
    /// object.
    constexpr any_completion_handler() : fn_table_(nullptr), impl_(nullptr)
    {
    }

    /// Construct an @c any_completion_handler in an empty state, without a target
    /// object.
    constexpr any_completion_handler(nullptr_t) : fn_table_(nullptr), impl_(nullptr)
    {
    }
     ...
     */
    any_completion_handler(any_completion_handler &&other) noexcept : fn_table_(other.fn_table_), impl_(other.impl_)
    {
