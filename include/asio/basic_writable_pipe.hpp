...
class basic_writable_pipe
{
  ...
  public:
     ...
     */
    basic_writable_pipe(const executor_type &ex, const native_handle_type &native_pipe) : impl_(0, ex)
    {
        asio::error_code ec;
     ...
     */
    template <typename ExecutionContext>
    basic_writable_pipe(ExecutionContext &context, const native_handle_type &native_pipe,
     ...
     * constructor.
     */
    basic_writable_pipe(basic_writable_pipe &&other) : impl_(std::move(other.impl_))
    {
    }
  ...
  private:
    ...
    class initiate_async_write_some
    {
      public:
        ...
        explicit initiate_async_write_some(basic_writable_pipe *self) : self_(self)
        {
        }
