...
class basic_system_executor
{
  ...
  public:
     ...
     */
    friend bool operator==(const basic_system_executor &, const basic_system_executor &) noexcept
    {
        return true;
    }
...
template <typename Blocking, typename Relationship, typename Allocator, typename Property>
struct query_member<asio::basic_system_executor<Blocking, Relationship, Allocator>, Property,
...
template <typename Blocking, typename Relationship, typename Allocator>
struct query_member<asio::basic_system_executor<Blocking, Relationship, Allocator>, asio::execution::allocator_t<void>>
{
    static constexpr bool is_valid = true;
    static constexpr bool is_noexcept = true;
