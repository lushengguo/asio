...
class logger_service : public asio::execution_context::service
{
  public:
    ...
    logger_service(asio::execution_context &context)
        : asio::execution_context::service(context), work_io_context_(), work_(asio::make_work_guard(work_io_context_)),
    ...
    void use_file(impl_type & /*impl*/, const std::string &file)
    {
        ...
        asio::post(work_io_context_, std::bind(&logger_service::use_file_impl, this, file));
    }
