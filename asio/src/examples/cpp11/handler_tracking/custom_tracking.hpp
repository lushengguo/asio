...
#define ASIO_ALSO_INHERIT_TRACKED_HANDLER , public ::custom_tracking::tracked_handler

#define ASIO_HANDLER_TRACKING_INIT ::custom_tracking::init()

#define ASIO_HANDLER_LOCATION(args) ::custom_tracking::location args

#define ASIO_HANDLER_CREATION(args) ::custom_tracking::creation args

#define ASIO_HANDLER_COMPLETION(args) ::custom_tracking::completion tracked_completion args
...
#define ASIO_HANDLER_OPERATION(args) ::custom_tracking::operation args

#define ASIO_HANDLER_REACTOR_REGISTRATION(args) ::custom_tracking::reactor_registration args

#define ASIO_HANDLER_REACTOR_DEREGISTRATION(args) ::custom_tracking::reactor_deregistration args
...
#define ASIO_HANDLER_REACTOR_EVENTS(args) ::custom_tracking::reactor_events args

#define ASIO_HANDLER_REACTOR_OPERATION(args) ::custom_tracking::reactor_operation args
...
struct custom_tracking
{
    ...
    static void creation(asio::execution_context & /*ctx*/, tracked_handler &h, const char *object_type,
                         void * /*object*/, std::uintmax_t native_handle, const char *op_name)
    {
        ...
        std::printf("Starting operation %s.%s for native_handle = %" PRIuMAX ", handler = %" PRIuMAX
                    ", tree = %" PRIuMAX "\n",
    ...
    struct completion
    {
        ...
        template <class... Args> void invocation_begin(Args &&.../*args*/)
        {
            std::printf("Entering handler %" PRIuMAX " in tree %" PRIuMAX "\n", handler_.handler_id_,
                        handler_.tree_id_);
        }
    ...
    static void operation(asio::execution_context & /*ctx*/, const char * /*object_type*/, void * /*object*/,
                          std::uintmax_t /*native_handle*/, const char * /*op_name*/)
    {
    }

    // Record that a descriptor has been registered with the reactor.
    static void reactor_registration(asio::execution_context &context, uintmax_t native_handle, uintmax_t registration)
    {
    ...
    static void reactor_deregistration(asio::execution_context &context, uintmax_t native_handle,
    ...
    static void reactor_events(asio::execution_context &context, uintmax_t registration, unsigned events)
    {
