...
/// typedef.
template <typename Service> class basic_logger
{
  public:
     ...
     */
    explicit basic_logger(asio::execution_context &context, const std::string &identifier)
        : service_(asio::use_service<Service>(context)), impl_(service_.null())
    {
