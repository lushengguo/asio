...
template <typename T, typename = void> struct is_completion_condition_helper : false_type
{
};
...
template <typename T> struct is_completion_condition
{
...
template <typename T> struct is_completion_condition : detail::is_completion_condition_helper<T>
{
};
