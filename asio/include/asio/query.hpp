...
struct can_query : integral_constant<bool, automatically_determined>
{
};
 ...
 */
template <typename T, typename Property>
struct is_nothrow_query : integral_constant<bool, automatically_determined>
{
};
...
template <typename T, typename Property>
struct can_query : integral_constant<bool, asio_query_fn::call_traits<query_t, T, void(Property)>::overload !=
