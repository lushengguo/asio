...
template <>
struct are_completion_signatures<> : true_type
{
};
...
template <typename T, typename R, typename... Args>
struct is_completion_handler_for<T, R(Args...) noexcept> : integral_constant<bool, (callable_with<decay_t<T>, Args...>)>
{
};
...
struct is_completion_handler_for<T, Signature0, SignatureN...>
    : integral_constant<bool, (is_completion_handler_for<T, Signature0>::value &&
...
struct are_any_lvalue_completion_signatures<Sig0> : is_lvalue_completion_signature<Sig0>
{
};

template <typename Sig0, typename... SigN>
struct are_any_lvalue_completion_signatures<Sig0, SigN...>
    : integral_constant<bool, (is_lvalue_completion_signature<Sig0>::value ||
...
template <typename Sig0>
struct are_any_rvalue_completion_signatures<Sig0> : is_rvalue_completion_signature<Sig0>
{
};

template <typename Sig0, typename... SigN>
struct are_any_rvalue_completion_signatures<Sig0, SigN...>
    : integral_constant<bool, (is_rvalue_completion_signature<Sig0>::value ||
...
class completion_handler_async_result
{
  public:
    ...
    {
        static_cast<Initiation &&>(initiation)(static_cast<RawCompletionToken &&>(token),
...
struct async_completion
{
    ...
    conditional_t<is_same<CompletionToken, completion_handler_type>::value, completion_handler_type &,
                  completion_handler_type>
        completion_handler;
...
struct async_result_has_initiate_memfn
    : integral_constant<bool, sizeof(async_result_initiate_memfn_helper<
                                     async_result<decay_t<CompletionToken>, Signatures...>>(0)) != 1>
{
};
...
inline auto async_initiate(Initiation &&initiation, type_identity_t<CompletionToken> &token, Args &&...args)
    -> decltype(enable_if_t<
                ...
                async_result<decay_t<CompletionToken>, Signatures...>>::initiate(static_cast<Initiation &&>(initiation),
...
template <ASIO_COMPLETION_SIGNATURE... Signatures, typename CompletionToken, typename Initiation, typename... Args>
...
template <typename CompletionToken, ASIO_COMPLETION_SIGNATURE... Signatures, typename Initiation, typename... Args>
inline
    typename enable_if_t<!enable_if_t<detail::are_completion_signatures<Signatures...>::value,
                                      detail::async_result_has_initiate_memfn<CompletionToken, Signatures...>>::value,
...
struct is_async_operation_call<Call,
                               void_t<enable_if_t<is_same<result_of_t<Call>, async_operation_probe_result>::value>>>
    : true_type
{
};
