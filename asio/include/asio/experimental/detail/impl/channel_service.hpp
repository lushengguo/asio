...
inline channel_service<Mutex>::channel_service(asio::execution_context &ctx)
    : asio::detail::execution_context_service_base<channel_service>(ctx), mutex_(), impl_list_(0)
{
}
                                         ...
                                         Handler &&handler)
{
    ...
    case buffer: {
        ...
        asio::detail::completion_payload_handler<payload_type, decay_t<Handler>>(static_cast<payload_type &&>(payload),
                                                                                 handler2.value)();
        return true;
    }
    case waiter: {
