...
static ASIO_INLINE_VARIABLE constexpr auto &error = std::placeholders::_1;
static ASIO_INLINE_VARIABLE constexpr auto &bytes_transferred = std::placeholders::_2;
static ASIO_INLINE_VARIABLE constexpr auto &iterator = std::placeholders::_2;
static ASIO_INLINE_VARIABLE constexpr auto &results = std::placeholders::_2;
static ASIO_INLINE_VARIABLE constexpr auto &endpoint = std::placeholders::_2;
static ASIO_INLINE_VARIABLE constexpr auto &signal_number = std::placeholders::_2;
