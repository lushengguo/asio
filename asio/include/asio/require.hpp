...
struct call_traits<Impl, T, void(Property), enable_if_t<is_applicable_property<decay_t<T>, decay_t<Property>>::value>,
                   enable_if_t<decay_t<Property>::is_requirable>, enable_if_t<static_require<T, Property>::is_valid>>
{
...
template <typename T, typename... Properties>
struct can_require
    : integral_constant<bool, asio_require_fn::call_traits<require_t, T, void(Properties...)>::overload !=
