...
class signal_set_service : public execution_context_service_base<signal_set_service>
{
  public:
    ...
    class registration
    {
      public:
        // Default constructor.
        registration()
            : signal_number_(0), queue_(0), undelivered_(0), next_in_table_(0), prev_in_table_(0), next_in_set_(0)
        {
        }
    ...
    ASIO_DECL asio::error_code add(implementation_type &impl, int signal_number, signal_set_base::flags_t f,
                                   asio::error_code &ec);
  ...
  private:
    ...
    {
      public:
        signal_op_cancellation(signal_set_service *s, implementation_type *i) : service_(s), implementation_(i)
        {
        }
