...
template <typename Time_Traits> class timer_queue : public timer_queue_base
{
  public:
    ...
    virtual long wait_duration_msec(long max_duration) const
    {
        ...
        return this->to_msec(Time_Traits::to_posix_duration(Time_Traits::subtract(heap_[0].time_, Time_Traits::now())),
                             max_duration);
    }
    ...
    virtual long wait_duration_usec(long max_duration) const
    {
        ...
        return this->to_usec(Time_Traits::to_posix_duration(Time_Traits::subtract(heap_[0].time_, Time_Traits::now())),
                             max_duration);
    }
  ...
  private:
    ...
    template <typename Time_Type> static bool is_positive_infinity(const Time_Type &)
    {
        return false;
    }
