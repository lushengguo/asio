...
class reactive_socket_connect_op_base : public reactor_op
{
  public:
    reactive_socket_connect_op_base(const asio::error_code &success_ec, socket_type socket, func_type complete_func)
        : reactor_op(success_ec, &reactive_socket_connect_op_base::do_perform, complete_func), socket_(socket)
    {
    }
...
class reactive_socket_connect_op : public reactive_socket_connect_op_base
{
  public:
    ...
    reactive_socket_connect_op(const asio::error_code &success_ec, socket_type socket, Handler &handler,
