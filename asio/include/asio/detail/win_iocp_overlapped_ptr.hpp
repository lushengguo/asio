...
class win_iocp_overlapped_ptr : private noncopyable
{
  public:
    ...
    explicit win_iocp_overlapped_ptr(const Executor &ex, Handler &&handler) : ptr_(0), iocp_service_(0)
    {
  ...
  private:
    ...
    static win_iocp_io_context *get_iocp_service(
        const Executor &ex, enable_if_t<can_query<const Executor &, execution::context_t>::value> * = 0)
    {
