...
class io_uring_file_service : public execution_context_service_base<io_uring_file_service>
{
  public:
    ...
    ASIO_DECL asio::error_code open(implementation_type &impl, const char *path, file_base::flags open_flags,
                                    asio::error_code &ec);
    ...
    ASIO_DECL uint64_t seek(implementation_type &impl, int64_t offset, file_base::seek_basis whence,
                            asio::error_code &ec);
