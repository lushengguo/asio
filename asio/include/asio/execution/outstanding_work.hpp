...
struct outstanding_work_t
{
    ...
    constexpr outstanding_work_t(untracked_t) : value_(0)
    {
    }

    constexpr outstanding_work_t(tracked_t) : value_(1)
    {
    }
    ...
    template <typename T>
    struct query_member : traits::query_member<typename proxy<T>::type, outstanding_work_t>
    {
    };
    ...
    friend constexpr outstanding_work_t query(const Executor &ex, convertible_from_outstanding_work_t,
...
template <typename T>
struct static_query<
    T, execution::outstanding_work_t::untracked_t,
...
template <typename T>
struct static_query<
    T, execution::outstanding_work_t::tracked_t,
