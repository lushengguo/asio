...
class spawned_coroutine_thread : public spawned_thread_base
{
  public:
    ...
    spawned_coroutine_thread(caller_type &caller) : caller_(caller), on_suspend_fn_(0), on_suspend_arg_(0)
    {
    }

    template <typename F>
    static spawned_thread_base *spawn(F &&f, const boost::coroutines::attributes &attributes,
    ...
    template <typename F>
    static spawned_thread_base *spawn(F &&f, cancellation_slot parent_cancel_slot = cancellation_slot(),
                                      cancellation_state cancel_state = cancellation_state())
    {
    ...
    class entry_point
    {
      public:
        ...
        entry_point(F &&f, spawned_coroutine_thread **spawned_thread_out)
            : function_(static_cast<F &&>(f)), spawned_thread_out_(spawned_thread_out)
        {
        }
...
class spawned_fiber_thread : public spawned_thread_base
{
  public:
    ...
    spawned_fiber_thread(fiber_type &&caller)
        : caller_(static_cast<fiber_type &&>(caller)), on_suspend_fn_(0), on_suspend_arg_(0)
    {
    }

    template <typename StackAllocator, typename F>
    static spawned_thread_base *spawn(allocator_arg_t, StackAllocator &&stack_allocator, F &&f,
                                      cancellation_slot parent_cancel_slot = cancellation_slot(),
                                      cancellation_state cancel_state = cancellation_state())
    {
...
{
  public:
    explicit spawned_thread_resumer(spawned_thread_base *spawned_thread) : spawned_thread_(spawned_thread)
    {
    }

    spawned_thread_resumer(spawned_thread_resumer &&other) noexcept : spawned_thread_(other.spawned_thread_)
    {
...
{
  public:
    explicit spawned_thread_destroyer(spawned_thread_base *spawned_thread) : spawned_thread_(spawned_thread)
    {
        spawned_thread->detach();
    }

    spawned_thread_destroyer(spawned_thread_destroyer &&other) noexcept : spawned_thread_(other.spawned_thread_)
    {
        other.spawned_thread_ = 0;
    }
...
class spawn_handler_base
{
  public:
    ...
    spawn_handler_base(const basic_yield_context<Executor> &yield)
        : yield_(yield), spawned_thread_(yield.spawned_thread_)
    {
        spawned_thread_->detach();
    }

    spawn_handler_base(spawn_handler_base &&other) noexcept
        : yield_(other.yield_), spawned_thread_(other.spawned_thread_)
...
class spawn_handler<Executor, R()> : public spawn_handler_base<Executor>
{
  public:
    ...
    spawn_handler(const basic_yield_context<Executor> &yield, result_type &) : spawn_handler_base<Executor>(yield)
    {
    }
...
class async_result<basic_yield_context<Executor>, Signature>
{
  public:
    ...
    struct suspend_with_helper
    {
        ...
        {
            static_cast<Initiation &&>(init_)(handler_type(yield_, result_),
    ...
    static return_type initiate(Initiation &&init, const basic_yield_context<Executor> &yield, InitArgs &&...init_args)
    {
        ...
        yield.spawned_thread_->suspend_with(suspend_with_helper<Initiation, InitArgs...>{
            result, static_cast<Initiation &&>(init), yield,
            std::tuple<InitArgs &&...>(static_cast<InitArgs &&>(init_args)...)});
...
class spawn_entry_point
{
  public:
    ...
    spawn_entry_point(const Executor &ex, F &&f, H &&h)
        : executor_(ex), function_(static_cast<F &&>(f)), handler_(static_cast<H &&>(h)), work_(handler_, executor_)
    {
    }
...
{
  public:
    spawn_cancellation_handler(const Handler &, const Executor &ex) : ex_(ex)
    {
    }
...
class initiate_spawn
{
  public:
    ...
    explicit initiate_spawn(const executor_type &ex) : executor_(ex)
    {
    }
    ...
    void operator()(Handler &&handler, allocator_arg_t, StackAllocator &&stack_allocator, F &&f) const
    {
        ...
        (dispatch)(executor_, spawned_thread_resumer(spawned_fiber_thread::spawn(
...
template <typename Executor, typename F,
          ASIO_COMPLETION_TOKEN_FOR(
              typename detail::spawn_signature<result_of_t<F(basic_yield_context<Executor>)>>::type) CompletionToken>
inline auto spawn(const Executor &ex, F &&function, CompletionToken &&token,
    ...
    -> decltype(async_initiate<CompletionToken,
        ...
        declval<detail::initiate_spawn<Executor>>(), token, static_cast<F &&>(function)))
{
...
inline auto spawn(ExecutionContext &ctx, F &&function, CompletionToken &&token,
    ...
    -> decltype(async_initiate<CompletionToken,
                               typename detail::spawn_signature<result_of_t<
                                   F(basic_yield_context<typename ExecutionContext::executor_type>)>>::type>(
        declval<detail::initiate_spawn<typename ExecutionContext::executor_type>>(), token,
...
template <typename Executor, typename F,
          ASIO_COMPLETION_TOKEN_FOR(
              typename detail::spawn_signature<result_of_t<F(basic_yield_context<Executor>)>>::type) CompletionToken>
inline auto spawn(const basic_yield_context<Executor> &ctx, F &&function, CompletionToken &&token,
#if defined(ASIO_HAS_BOOST_COROUTINE)
                  constraint_t<!is_same<decay_t<CompletionToken>, boost::coroutines::attributes>::value>,
#endif // defined(ASIO_HAS_BOOST_COROUTINE)
                  constraint_t<is_executor<Executor>::value || execution::is_executor<Executor>::value>)
...
template <typename Executor, typename StackAllocator, typename F,
          ASIO_COMPLETION_TOKEN_FOR(
              typename detail::spawn_signature<result_of_t<F(basic_yield_context<Executor>)>>::type) CompletionToken>
inline auto spawn(const Executor &ex, allocator_arg_t, StackAllocator &&stack_allocator, F &&function,
                  CompletionToken &&token,
                  constraint_t<is_executor<Executor>::value || execution::is_executor<Executor>::value>)
    -> decltype(async_initiate<CompletionToken,
                               typename detail::spawn_signature<result_of_t<F(basic_yield_context<Executor>)>>::type>(
        declval<detail::initiate_spawn<Executor>>(), token, allocator_arg_t(),
        static_cast<StackAllocator &&>(stack_allocator), static_cast<F &&>(function)))
{
    return async_initiate<CompletionToken,
                          typename detail::spawn_signature<result_of_t<F(basic_yield_context<Executor>)>>::type>(
...
template <typename ExecutionContext, typename StackAllocator, typename F,
          ASIO_COMPLETION_TOKEN_FOR(
              typename detail::spawn_signature<
                  result_of_t<F(basic_yield_context<typename ExecutionContext::executor_type>)>>::type) CompletionToken>
inline auto spawn(ExecutionContext &ctx, allocator_arg_t, StackAllocator &&stack_allocator, F &&function,
                  CompletionToken &&token, constraint_t<is_convertible<ExecutionContext &, execution_context &>::value>)
    -> decltype(async_initiate<CompletionToken,
                               typename detail::spawn_signature<result_of_t<
                                   F(basic_yield_context<typename ExecutionContext::executor_type>)>>::type>(
        declval<detail::initiate_spawn<typename ExecutionContext::executor_type>>(), token, allocator_arg_t(),
        static_cast<StackAllocator &&>(stack_allocator), static_cast<F &&>(function)))
{
...
template <typename Executor, typename StackAllocator, typename F,
          ASIO_COMPLETION_TOKEN_FOR(
              typename detail::spawn_signature<result_of_t<F(basic_yield_context<Executor>)>>::type) CompletionToken>
inline auto spawn(const basic_yield_context<Executor> &ctx, allocator_arg_t, StackAllocator &&stack_allocator,
...
class old_spawn_entry_point
{
  public:
    ...
    old_spawn_entry_point(const Executor &ex, F &&f, H &&h)
        : executor_(ex), function_(static_cast<F &&>(f)), handler_(static_cast<H &&>(h))
    {
    }
...
template <typename Function>
inline void spawn(Function &&function, const boost::coroutines::attributes &attributes)
{
...
void spawn(Handler &&handler, Function &&function, const boost::coroutines::attributes &attributes,
...
inline void spawn(const Executor &ex, Function &&function, const boost::coroutines::attributes &attributes,
                  constraint_t<is_executor<Executor>::value || execution::is_executor<Executor>::value>)
{
...
{
    asio::spawn(asio::bind_executor(ex, &detail::default_spawn_handler), static_cast<Function &&>(function),
                attributes);
}
...
inline void spawn(ExecutionContext &ctx, Function &&function, const boost::coroutines::attributes &attributes,
                  constraint_t<is_convertible<ExecutionContext &, execution_context &>::value>)
{
