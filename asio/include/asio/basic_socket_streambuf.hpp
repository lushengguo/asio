...
#endif // defined(ASIO_NO_DEPRECATED) || defined(GENERATING_DOCUMENTATION)
{
  ...
  public:
    ...
    basic_socket_streambuf()
        : detail::socket_streambuf_io_context(new io_context), basic_socket<Protocol>(*default_io_context_),
    ...
    explicit basic_socket_streambuf(basic_stream_socket<protocol_type> s)
        : detail::socket_streambuf_io_context(0), basic_socket<Protocol>(std::move(s)), expiry_time_(max_expiry_time())
    {
        init_buffers();
    }
    ...
    basic_socket_streambuf(basic_socket_streambuf &&other)
        : detail::socket_streambuf_io_context(other), basic_socket<Protocol>(std::move(other.socket())), ec_(other.ec_),
  ...
  protected:
    int_type underflow()
    {
        ...
        for (;;)
        {
            ...
            detail::buffer_sequence_adapter<mutable_buffer, mutable_buffer> bufs(asio::buffer(get_buffer_) +
                                                                                 putback_max);
