...
template <typename Executor = any_io_executor> class basic_stream_descriptor : public basic_descriptor<Executor>
{
  ...
  public:
     ...
     */
    template <typename ExecutionContext>
    basic_stream_descriptor(ExecutionContext &context, const native_handle_type &native_descriptor,
     ...
     * constructor.
     */
    basic_stream_descriptor(basic_stream_descriptor &&other) noexcept : basic_descriptor<Executor>(std::move(other))
    {
    }
